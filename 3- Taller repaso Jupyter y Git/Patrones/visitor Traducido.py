...
if __name__ == "__main__":
    ...
    eb=TextBlob("The client code works with all visitors via the base Visitor interface:")
    print(eb.translate(from_lang="en", to="es"))
    visitor1 = ConcreteVisitor1()
    client_code(components, visitor1)

    eb=TextBlob("It allows the same client code to work with different types of visitors:")
    print(eb.translate(from_lang="en", to="es"))
